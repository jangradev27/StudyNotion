...
exports.CreateCourse=async(req,res)=>{
    try{
        const{CourseName,CourseDescription,WhatLearn,price,category}=req.body;
        ...
        const ThumbanilImage=await Uploader(thumbnail,process.env.PhotoFolderName);

        // create an entry for new Course
        console.log(ThumbanilImage)
        const NewCourse=await Course.create({
            CourseName,
            CourseDescription,
            instructor:user._id,
            WhatLearn,
            price,category:validCategory._id,
            thumbnail:ThumbanilImage.secure_url
        })
