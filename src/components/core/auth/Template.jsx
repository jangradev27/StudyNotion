...
export const Template = ({formtype,heading,description1,description2}) => { 
  ...
  return (
    <div className='  flex justify-center items-center p-5 min-h-screen   '>
      <div className={` ${Loading?"hidden":"flex"}  flex-col-reverse sm:flex-row  w-11/12 max-w-maxContent h-full gap-5 justify-between items-center  p-2 `}>
          ...
          <div className='relative ml-5 w-full lg:w-[500px] lg:h-[450px] flex  sm:hidden lg:flex  justify-center items-center '>
              <img src={image} className='absolute z-[2] -top-2 -left-5' />
              <img src={crossframe}/>
          </div>
